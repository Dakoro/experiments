from kmeans_mojo import Matrix, Kmeans
from kmeans_mojo.utils import list_to_matrix
...
def bench_python_kmeans(n_clusters: Int, borrowed data: PythonObject) -> Float64:
    Python.add_to_path(".")
    py_kmeans = Python.import_module("kmeans_python")
...
def main():
    ...
    Python.add_to_path(".")
    py_utils = Python.import_module("kmeans_python.utils")
